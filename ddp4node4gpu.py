...
Master:    $ python3 ddp1node4gpu.py -n 4 -g 1 -nr 0 --epochs 20 -b 25
Worker 1:  $ python3 ddp1node4gpu.py -n 4 -g 1 -nr 1 --epochs 20 -b 25
Worker 2:  $ python3 ddp1node4gpu.py -n 4 -g 1 -nr 2 --epochs 20 -b 25
Worker 3:  $ python3 ddp1node4gpu.py -n 4 -g 1 -nr 3 --epochs 20 -b 25
