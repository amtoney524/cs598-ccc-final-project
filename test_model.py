'''
  ...
  This is the PyTorch code which evalautes the trained model's
  ability to detect the presence of COVID-19 in chest X-ray images.
'''
...
description='COVID-19 Detection from X-ray Images'
test_covid_path = "data/test/covid/"
test_non_covid_path = "data/test/non-covid/"
trained_model_path = "covid_resnet18_epoch20.pt"
cut_off_threshold = 0.2 # Any sample with probability higher than this is considered COVID-19 (default: 0.2)
batch_size = 20
num_workers = 0
...
test_non = glob.glob("%s*" % test_non_covid_path)
...
ax = sn.heatmap(df_cm, cmap=plt.cm.Blues, annot=True, cbar=False, fmt='g', xticklabels=['Non-COVID', 'COVID-2019'],
                yticklabels=['Non-COVID', 'COVID-2019'])
